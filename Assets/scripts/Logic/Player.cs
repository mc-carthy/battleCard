...
public class Player : MonoBehaviour, ICharacter
{
    ...
    public void HighlightPlayableCards(bool removeAllHighlights = false)
    {
        ...
        foreach (CardLogic cl in hand.CardsInHand)
        {
            ...
            if (g!=null)
                g.GetComponent<CardManager>().CanBePlayedNow = (cl.CurrentManaCost <= ManaLeft) && !removeAllHighlights;
        }
        ...
        foreach (CreatureLogic crl in table.CreaturesOnTable)
        {
            ...
            if(g!= null)
                g.GetComponent<CreatureManager>().CanAttackNow = (crl.AttacksLeftThisTurn > 0) && !removeAllHighlights;
        }   
